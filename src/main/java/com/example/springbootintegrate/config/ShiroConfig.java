package com.example.springbootintegrate.config;
...
import com.example.springbootintegrate.shiro.MyShiroRealm;
import com.example.springbootintegrate.shiro.filter.KickoutSessionControlFilter;
...
//        filterChainDefinitionMap.put("/reportArticle/**", "authc");
    ...
    public RedisManager redisManager() {
        ...
        System.out.println("timeout = " + duration.getNano());
        System.out.println("timeout = " + duration.getSeconds());
